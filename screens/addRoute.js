...
const Rutas = ({navigation}) => {
  ...
  const handleRegister = async values => {
    ...
    Axios.post(
      `https://ws-production-b7ca.up.railway.app/api/ruta`,
      {
        user: _id,
        nameRuta: values.nameRuta,
        price: values.price,
      },
      config,
    )
          ...
          <View
            ...
            <View style={{marginTop: SIZES.padding * 3}}>
              ...
              <TextInput
                ...
                placeholder="Agregar nombre de ruta..."
                placeholderTextColor={COLORS.white}
                selectionColor={COLORS.white}
                onChangeText={handleChange('nameRuta')}
                onBlur={handleBlur('nameRuta')}
                value={values.nameRuta}
              />
            </View>
            <View style={{marginTop: SIZES.padding * 3}}>
              <Text style={{color: COLORS.lightGreen, ...FONTS.body3}}>
              ...
              <TextInput
                ...
                placeholder="Agrega precio de ruta..."
                placeholderTextColor={COLORS.white}
                selectionColor={COLORS.white}
